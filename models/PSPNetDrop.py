...
def build_pspnet_drop(inputs, dropout_rate, label_size, num_classes, preset_model='PSPNetDrop', frontend="ResNet101", pooling_type = "MAX", weight_decay=1e-5, upscaling_method="conv", is_training=True, pretrained_dir="models"):
    """
    ...
    net1 = slim.dropout(psp, dropout_rate, is_training = is_training)
    ...
    net2 = slim.dropout(psp, 1-dropout_rate, is_training = is_training)

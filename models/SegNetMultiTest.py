...
def build_segnet_multi_test(inputs, num_classes, preset_model = "Encoder-Decoder-Multi", dropout_p=0.5, scope=None):
	"""
	...
	skip_1 = net
	intermediates.append(skip_1)

	net = conv_block(net, 128)
	net = conv_block(net, 128)
	net = slim.pool(net, [2, 2], stride=[2, 2], pooling_type='MAX')
	skip_2 = net
	intermediates.append(skip_2)
	...
	return net1, net2, intermediates
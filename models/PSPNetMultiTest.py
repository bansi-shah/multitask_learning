...
def build_psp_multi_test(inputs, label_size, num_classes, preset_model='PSPNetMulti', frontend="ResNet101", pooling_type = "MAX", weight_decay=1e-5, upscaling_method="conv", is_training=True, pretrained_dir="models"):
    """
    ...
    return psp, x, y, net1, net2, init_fn

...
# parser.add_argument('--num_val_images', type=int, default=50, required=False, help='Number of images for testing')

args = parser.parse_args()

# Get the names of the classes so we can record the evaluation results
print("Retrieving dataset information ...")
dataset_path = utils.dataset_dir[args.dataset]['path']
...
for ind in range(40):
    ...
    input_image, gt = input_image[:args.crop_width, :args.crop_height, :], gt[:args.crop_width, :args.crop_height, :] 
    ...
    # cv2.imwrite("%s/%s_orig.png"%("Test", file_name),cv2.cvtColor(orig, cv2.COLOR_RGB2BGR))

...
parser.add_argument('--model', type=str, default="PSPNetMulti", help='The model you are using. See model_builder.py for supported models')
parser.add_argument('--frontend', type=str, default="ResNet101", help='The frontend you are using. See frontend_builder.py for supported models')
parser.add_argument('--checkpoint_path', type=str, default="psp_multi_attention32", help='The path to save the checkpoint')
...
for epoch in range(args.epoch_start_i, args.num_epochs):
    ...
    loss_param1.assign(mean_loss1/(mean_loss1+mean_loss2))
    loss_param2.assign(mean_loss2/(mean_loss1+mean_loss2))

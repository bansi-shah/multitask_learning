...
parser.add_argument('--model', type=str, default="PSPAutoDrop", help='The model you are using. See model_builder.py for supported models')
parser.add_argument('--frontend', type=str, default="ResNet101", help='The frontend you are using. See frontend_builder.py for supported models')
parser.add_argument('--checkpoint_path', type=str, default="auto_dropout_decay", help='The path to save the checkpoint')
...
dropout_rate1 = tf.Variable(dropout, name='dropout_rate1')
dropout_rate2 = tf.Variable(dropout, name='dropout_rate2')

network, init_fn = model_builder.build_model(model_name=args.model, frontend=args.frontend, net_input=net_input, num_classes=num_classes, crop_width=args.crop_width, crop_height=args.crop_height, is_training=True, dropout_rate=[dropout_rate1, dropout_rate2])
...
for epoch in range(args.epoch_start_i, args.num_epochs):
    ...
    for i in range(num_iters):
        ...
        new_rate = utils.calculate_complexity(input_image)
        if new_rate < threshold:
            ...
            new_rate1 = 1 - dropout
            new_rate2 = dropout
        a3 = dropout_rate1.assign(new_rate1-new_rate1*decay)
        a4 = dropout_rate2.assign(new_rate2-new_rate2*decay)
        sess.run([a3, a4])
